...
category: [FAQ]
order: 4
description: 我們在 GitHub 議題頁面使用了多種標籤來標記用戶提交的問題，你可以通過這些標籤來確認問題的狀態。
banner: https://opengraph.snapgenshin.cn/generate?url=https://hut.ao/zh/advanced/known-issue.html&has_description=False
---

# 已知問題

你可以在 [GitHub Issue 頁面](https://github.com/DGP-Studio/Snap.Hutao/issues?q=is%3Aissue)查看全部的議題
...
| [將在下一版本修復的問題](https://github.com/DGP-Studio/Snap.Hutao/issues?q=is%3Aissue%20label%3A%E7%AD%89%E5%BE%85%E5%8F%91%E5%B8%83) | 包含標籤 `等待發布` |
