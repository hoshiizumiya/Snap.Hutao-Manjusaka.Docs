...
order: 7
description: Snap Hutao Manjusaka hopes to help players from all over the world. In addition to maintaining the Simplified Chinese and English versions of the program, we also accept translations provided by community members.
banner: https://opengraph.snapgenshin.cn/generate?url=https://hut.ao/en/i18n.html
---

# Localization
::: warning
Manjusaka version of Snap Hutao Manjusaka is currently in maintenance mode. For internationalization support or optimization, please proactively raise relevant issues. Some language translations may be of poor quality or outdated, please understand.
:::
Snap Hutao Manjusaka primarily focuses on supporting the Genshin Impact Chinese server. Currently, we are gradually improving support for oversea servers, encompassing language localization and feature internationalization.
...
Snap Hutao Manjusaka currently supports the following languages:
